...
| ~~**Weitere Store-Sprachen**~~ **Aufgehoben 23.09.2026** | Die Bedingung ist erfüllt: Die App spricht jetzt es, fr, id, it, pt, tr zusätzlich zu EN/DE, und `AchievementsScreen` war schon übersetzt. Store-Texte und -Bilder für die sechs liegen bereit (`docs/WACHSTUM.md`). Die ursprüngliche Begründung bleibt richtig für jede *weitere* Sprache: erst die App übersetzen, dann den Eintrag. |
