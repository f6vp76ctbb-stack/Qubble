...
```
lib/
  l10n/           # app_en.arb (Quelle) + ar/bg/cs/da/de/el/es/fi/fil/fr/he/hi/hr/hu/id/it/ja/ko/ms/nb/nl/pl/pt/ro/sk/sv/th/tr/uk/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in einunddreißig
  Sprachen (ar, bg, cs, da, de, el, es, fi, fil, fr, he, hi, hr, hu, id, it, ja, ko, ms, nb, nl, pl, pt, ro, sk, sv, th, tr, uk, vi, zh — Chinesisch
  ...
  sonst lädt der Web-Build Schriften von Google nach. Ausnahme: ar/el/he/hi/ja/ko/th/zh stehen in
  ...
  `Locale(code)`. Arabisch und Hebräisch sind RTL: Layout richtungsneutral schreiben
