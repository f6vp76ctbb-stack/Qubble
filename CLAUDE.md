...
```
lib/
  l10n/           # app_en.arb (Quelle) + ar/bg/cs/da/de/el/es/fi/fr/hi/hr/hu/id/it/ja/ko/ms/nb/nl/pl/pt/ro/sk/sv/th/tr/uk/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in neunundzwanzig
  Sprachen (ar, bg, cs, da, de, el, es, fi, fr, hi, hr, hu, id, it, ja, ko, ms, nb, nl, pl, pt, ro, sk, sv, th, tr, uk, vi, zh — Chinesisch
  ...
  sonst lädt der Web-Build Schriften von Google nach. Ausnahme: ar/el/hi/ja/ko/th/zh stehen in
  ...
  `Locale(code)`. Arabisch ist RTL: Layout richtungsneutral schreiben
