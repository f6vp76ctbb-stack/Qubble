...
```
lib/
  l10n/           # app_en.arb (Quelle) + ar/de/es/fr/id/it/ja/ko/nl/pl/pt/th/tr/uk/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in sechzehn
  Sprachen (ar, de, es, fr, id, it, ja, ko, nl, pl, pt, th, tr, uk, vi, zh — Chinesisch
  ...
  sonst lädt der Web-Build Schriften von Google nach. Ausnahme: ar/ja/ko/th/zh stehen in
  ...
  („+6", „+30%") mit `textDirection: TextDirection.ltr`. Plural-Zweige `=1{…}`
