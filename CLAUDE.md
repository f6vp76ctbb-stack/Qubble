...
```
lib/
  l10n/           # app_en.arb (Quelle) + de/es/fr/id/it/ja/ko/nl/pl/pt/th/tr/vi (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in dreizehn
  Sprachen (de, es, fr, id, it, ja, ko, nl, pl, pt, th, tr, vi — seit 23.09.2026). Neue Strings gehören
  ...
  sonst lädt der Web-Build Schriften von Google nach. Ausnahme: ja/ko/th stehen in
  `kNativeOnlyLanguages` (`lib/ui/locale.dart`) — nur Android/iOS, der Web-Build
  lässt sie weg (das Handy zeichnet CJK/Thai mit der Systemschrift). Plural-Zweige `=1{…}`
