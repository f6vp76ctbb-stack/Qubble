...
```
lib/
  l10n/           # app_en.arb (Quelle) + ar/de/es/fr/hi/id/it/ja/ko/ms/nl/pl/pt/ro/th/tr/uk/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in neunzehn
  Sprachen (ar, de, es, fr, hi, id, it, ja, ko, ms, nl, pl, pt, ro, th, tr, uk, vi, zh — Chinesisch
