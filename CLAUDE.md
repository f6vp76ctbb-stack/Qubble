...
```
lib/
  l10n/           # app_en.arb (Quelle) + ar/de/es/fr/id/it/ja/ko/nl/pl/pt/th/tr/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in fünfzehn
  Sprachen (ar, de, es, fr, id, it, ja, ko, nl, pl, pt, th, tr, vi, zh — Chinesisch
