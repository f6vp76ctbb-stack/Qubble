...
```
lib/
  l10n/           # app_en.arb (Quelle) + de/es/fr/id/it/ja/ko/nl/pl/pt/th/tr/vi/zh/zh_Hant (Übersetzungen), generiert: L10n
...
- **Englisch ist die Quellsprache für Nutzer-Texte**; übersetzt wird in vierzehn
  Sprachen (de, es, fr, id, it, ja, ko, nl, pl, pt, th, tr, vi, zh — Chinesisch
  ...
  sonst lädt der Web-Build Schriften von Google nach. Ausnahme: ja/ko/th/zh stehen in
