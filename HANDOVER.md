...
Auftrag „Downloads stärken". Die App spricht jetzt **sechsundzwanzig Sprachen** (en,
de, ar, cs, da, el, es, fr, hi, hu, id, it, ja, ko, ms, nl, pl, pt, ro, sk, sv, th, tr, uk, vi, zh — Chinesisch
vereinfacht `zh` und traditionell `zh_Hant`; Arabisch von rechts nach links);
Store-Texte, Screenshots und Feature-Grafik für die vierundzwanzig neuen liegen
