...
Auftrag „Downloads stärken". Die App spricht jetzt **fünfzehn Sprachen** (en,
de, es, fr, id, it, ja, ko, nl, pl, pt, th, tr, vi, zh — Chinesisch vereinfacht
`zh` und traditionell `zh_Hant`); Store-Texte, Screenshots und Feature-Grafik
für die dreizehn neuen liegen bereit. Japanisch/Koreanisch/Thai/Chinesisch nur
