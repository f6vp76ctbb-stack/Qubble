...
Tests: 828 → **1878**, `flutter analyze` ohne Befund.
...
|---|---|---|---|---|---|
| A | ~~Zweite Sprachwelle: Vietnamesisch, Polnisch, Niederländisch~~ und ~~Japanisch, Koreanisch, Thai, Chinesisch~~ **erledigt** (App, Store-Texte, Bilder) | hoch | mittel | ich | Kyrillisch (Russisch) ebenfalls von Nunito abgedeckt — aber Play-Abrechnung und AdMob in Russland: vor einer Entscheidung belegen, nicht annehmen |
