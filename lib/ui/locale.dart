...
/// web build does not offer these languages; an Arabic, Hindi, Japanese,
/// Korean, Thai or Chinese browser gets English there, as it did before they
/// existed. Listed
...
/// not on it.
const Set<String> kNativeOnlyLanguages = {'ar', 'hi', 'ja', 'ko', 'th', 'zh'};
