...
/// web build does not offer these languages; an Arabic, Japanese, Korean,
/// Thai or Chinese browser gets English there, as it did before they existed. Listed
...
/// not on it.
const Set<String> kNativeOnlyLanguages = {'ar', 'ja', 'ko', 'th', 'zh'};
