...
class _FeedbackScreenState extends State<FeedbackScreen> {
  ...
  Future<void> _send(Uri? uri, {required String failureHint}) async {
    if (uri == null) {
      _toast('Bitte zuerst etwas eintippen.');
      return;
    }
    ...
    if (ok) {
      _toast('Danke! Schick die Nachricht ab.');
  ...
  Future<void> _submitMail() => _send(
    ...
    failureHint: 'Keine Mail-App gefunden. Probier den GitHub-Weg darunter.',
  );

  Future<void> _submitGithub() => _send(
    buildFeedbackIssueUri(_controller.text, context: _context),
    failureHint: 'GitHub ließ sich nicht öffnen. Später erneut versuchen.',
  );
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Was gefällt dir, was nervt, was fehlt? Auch Kleinigkeiten '
                'helfen — je konkreter, desto besser.',
              ...
              Text(
                'Angehängt werden nur ${AppInfo.label} und dein Gerätetyp — '
                'damit ich weiß, welcher Build gemeint ist.',
              ...
              if (mailAvailable)
                FilledButton.icon(
                  ...
                  label: const Text('Per Mail senden'),
              ...
              mailAvailable
                  ? TextButton.icon(
                      ...
                      label: const Text('Lieber als GitHub-Issue'),
              ...
              if (!mailAvailable)
                const Padding(
                  ...
                  child: Text(
                    'Es öffnet sich GitHub — dort noch auf „Submit new issue“ '
                    'tippen. (Einmaliger GitHub-Login nötig.)',
                    style: TextStyle(
                      color: GridColors.textMuted,
                      fontSize: 12,
                    ),
