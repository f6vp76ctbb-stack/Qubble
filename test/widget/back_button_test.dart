...
void main() {
  group('home', () {
    testWidgets('one back press warns instead of closing the app',
      ...
      expect(find.text('Nochmal zurück zum Beenden'), findsOneWidget);
  ...
  group('puzzle', () {
    testWidgets('back mid-level asks before discarding', (tester) async {
      ...
      expect(find.text('Rätsel verlassen?'), findsOneWidget);
    });
    ...
    testWidgets('back on an untouched level leaves straight away',
      ...
      expect(find.text('Rätsel verlassen?'), findsNothing,
